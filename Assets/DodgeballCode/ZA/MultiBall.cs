...
public class MultiBall : UdonSharpBehaviour
{
  ...
  public void SpawnExtraDodgeballs(VRCPlayerApi player, Transform originalDodgeballPos)
  {
    if (player != null && originalDodgeballPos != null)
    {
      ...
      GameObject dodgeball1 = VRCInstantiate(dodgeballPrefab, spawnPos + Vector3.left * 0.5f + Vector3.forward * 2f, Quaternion.identity);
      GameObject dodgeball2 = VRCInstantiate(dodgeballPrefab, spawnPos + Vector3.right * 0.5f + Vector3.forward * 2f, Quaternion.identity);
